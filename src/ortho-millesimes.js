...
export const MILLESIMES = [
  ...
  },
  {
    id: '2011_ortho_irc',
    annee: 2011,
    layer: '2011_ortho_irc',
    libelle: 'Ortho 2011 — infrarouge colorisé',
    categorie: 'irc',
    principal: false,
  },
  {
    id: '2016_orthomel_5cm',
    annee: 2016,
    layer: '2016_orthomel_5cm',
    libelle: 'Ortho 2016 MEL',
    categorie: 'standard',
    principal: true,
    resolution: '5 cm',
  },
  {
    id: '2016_trueorthomel_7cm',
    annee: 2016,
    layer: '2016_trueorthomel_7cm',
    libelle: 'Ortho 2016 MEL (sans dévers)',
    categorie: 'sans-devers',
    principal: false,
    resolution: '7 cm',
  },
  {
    id: '2018_ortho_ppige',
    annee: 2018,
    layer: '2018_ortho_ppige',
    libelle: 'Ortho 2018 PPIGE',
    categorie: 'standard',
    principal: true,
    resolution: '20 cm',
  },
  {
    id: '2020_ortho_mel_5cm',
    annee: 2020,
    layer: '2020_ortho_mel_5cm',
    libelle: 'Ortho 2020 MEL',
    categorie: 'standard',
    principal: true,
    resolution: '5 cm',
  },
  {
    id: '2020_ortho_ccpc_5cm',
    annee: 2020,
    layer: '2020_ortho_ccpc_5cm',
    libelle: 'Ortho 2020 CCPC',
    categorie: 'ccpc',
    principal: false,
    resolution: '5 cm',
  },
  {
    id: '2020_ortho_stereo_mel_5cm',
    annee: 2020,
    layer: '2020_ortho_stereo_mel_5cm',
    libelle: 'Ortho 2020 MEL (stéréoscopique)',
    categorie: 'stereo',
    principal: false,
    resolution: '5 cm',
  },
  {
    id: '2021_ortho_ign_20cm',
    annee: 2021,
    layer: '2021_ortho_ign_20cm',
    libelle: 'Ortho 2021 IGN',
    categorie: 'standard',
    principal: true,
    resolution: '20 cm',
  },
  {
    id: '2022_ortho_mel_5cm',
    annee: 2022,
    layer: '2022_ortho_mel_5cm',
    libelle: 'Ortho 2022 MEL',
    categorie: 'standard',
    principal: true,
    resolution: '5 cm',
  },
  {
    id: '2025_ortho_mel_5cm',
    annee: 2025,
    layer: '2025_ortho_mel_5cm',
    libelle: 'Ortho 2025 MEL (hiver)',
    categorie: 'standard',
    principal: true,
    resolution: '5 cm',
  },
...
export function pourAnnee(annee) {
  return MILLESIMES.filter((m) => m.annee === annee).sort(
